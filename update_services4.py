...
/* Premium Card Styles (Light & Delicate) */
.k-card-premium {
...
.k-card-premium .k-card-header {
    ...
    background: url('data:image/svg+xml;utf8,<svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg"><defs><pattern id="dots" width="20" height="20" patternUnits="userSpaceOnUse"><circle cx="2" cy="2" r="1" fill="%23facc15" fill-opacity="0.2"/></pattern></defs><rect width="100%" height="100%" fill="url(%23dots)"/></svg>');
}
.k-card-premium .k-plan-name {
    color: #854d0e;
}
.k-card-premium .k-plan-speed {
    color: #a16207;
}
...
try:
    ...
    # Increase the container width for the section containing the cards
    content = content.replace('<section class="section">\n        <div class="container">', '<section class="section">\n        <div class="container" style="max-width: 1500px; padding: 0 2rem;">')
